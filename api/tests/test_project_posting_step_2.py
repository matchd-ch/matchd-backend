...
def test_step_2_as_company(user_employee, company_project_posting_object, login, project_posting_step_2):
    _test_step_2(user_employee, user_employee.employee, user_employee.company, None, company_project_posting_object,
                 login, project_posting_step_2)


@pytest.mark.django_db
def test_step_2_as_student(user_student, company_project_posting_object, login, project_posting_step_2):
    _test_step_2(user_student, None, None, user_student.student, company_project_posting_object, login,
                 project_posting_step_2)


def _test_step_2(user, employee, company, student, company_project_posting_object, login, project_posting_step_2):
    login(user)
    ...
    data, errors = project_posting_step_2(user, company_project_posting_object.id, ProjectPostingState.PUBLIC, employee)
...
@pytest.mark.django_db
def test_step_2_without_login(user_employee, company_project_posting_object, project_posting_step_2):
    data, errors = project_posting_step_2(AnonymousUser(), company_project_posting_object.id,
...
@pytest.mark.django_db
def test_step_2_with_invalid_step(user_employee, company_project_posting_object, login, project_posting_step_2):
    login(user_employee)
    company_project_posting_object.form_step = 1
    company_project_posting_object.save()
    data, errors = project_posting_step_2(user_employee, company_project_posting_object.id, ProjectPostingState.PUBLIC,
...
def test_step_2_as_employee_from_another_company(user_employee, user_employee_2, company_project_posting_object, login,
    ...
    company_project_posting_object.save()
    data, errors = project_posting_step_2(user_employee_2, company_project_posting_object.id,
                                          ProjectPostingState.PUBLIC, user_employee.employee)
    assert errors is None
    assert data is not None
    assert data.get('projectPostingStep2') is not None
...
@pytest.mark.django_db
def test_step_2_as_student_with_project_of_company(user_employee, user_student, company_project_posting_object, login,
                                                   project_posting_step_2):
    login(user_employee)
    company_project_posting_object.form_step = 2
    company_project_posting_object.company = user_employee.company
    ...
    company_project_posting_object.student = None
    company_project_posting_object.save()
    data, errors = project_posting_step_2(user_student, company_project_posting_object.id, ProjectPostingState.PUBLIC,
                                          user_employee.employee)
    assert errors is None
    assert data is not None
    assert data.get('projectPostingStep2') is not None
...
@pytest.mark.django_db
def test_step_2_as_company_with_project_of_student(user_employee, user_student, company_project_posting_object, login,
                                                   project_posting_step_2):
    login(user_employee)
    company_project_posting_object.form_step = 2
