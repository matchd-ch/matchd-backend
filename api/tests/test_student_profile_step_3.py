...
@pytest.mark.django_db
def test_step_3_without_login(user_student, student_step_3, soft_skill_objects,
...
@pytest.mark.django_db
def test_step_3_as_company(login, user_employee, student_step_3, soft_skill_objects,
                           cultural_fit_objects):
    login(user_employee)
...
@pytest.mark.django_db
def test_step_3_invalid_step(login, user_student, student_step_3, soft_skill_objects,
                             cultural_fit_objects):
...
@pytest.mark.django_db
def test_step_3_with_invalid_data(login, user_student, student_step_3, soft_skill_objects,
                                  cultural_fit_objects):
    user_student.student.profile_step = 3
    user_student.student.save()
    login(user_student)
...
@pytest.mark.django_db
def test_step_3_with_too_many_soft_skills_and_cultural_fits(login, user_student, student_step_3,
                                                            soft_skill_objects,
                                                            cultural_fit_objects):
    user_student.student.profile_step = 3
    user_student.student.save()
...
@pytest.mark.django_db
def test_step_3_with_too_few_soft_skills_and_cultural_fits(login, user_student, student_step_3,
                                                           soft_skill_objects,
                                                           cultural_fit_objects):
    user_student.student.profile_step = 3
    user_student.student.save()
