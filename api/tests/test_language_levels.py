...
def test_query(query_language_levels, language_level_objects):
    ...
    assert_node_id(edges[0].get('node'), f'LanguageLevel:{language_level_objects[0].id}')
    assert_node_id(edges[1].get('node'), f'LanguageLevel:{language_level_objects[2].id}')
    assert_node_id(edges[2].get('node'), f'LanguageLevel:{language_level_objects[1].id}')
...
def test_node_query(query_language_level_node, language_level_objects):
    data, errors = query_language_level_node(AnonymousUser(), f'LanguageLevel:{language_level_objects[0].id}')
    ...
    assert_node_id(node, f'LanguageLevel:{language_level_objects[0].id}')
