...
def _test_step_1(user, login, project_posting_step_1, topic_objects, project_type_objects,
                 keyword_objects):
    login(user)
    data, errors = project_posting_step_1(user, 'title', 'description', 'additional information', topic_objects[0], project_type_objects[0],
                                          keyword_objects)
...
def test_step_1_without_login(project_posting_step_1, topic_objects, project_type_objects,
                              keyword_objects):
    data, errors = project_posting_step_1(AnonymousUser(), 'title', 'description', 'additional information', topic_objects[0], project_type_objects[0],
                                          keyword_objects)
