...
def test_step_1(login, user_rector, university_step_1):
    ...
    assert data.get('universityProfileStep1').get('success')
...
@pytest.mark.django_db
def test_step_1_invalid_step(login, user_rector, university_step_1):
    ...
    assert data is not None
    assert data.get('universityProfileStep1') is not None
    assert data.get('universityProfileStep1').get('success') is False
