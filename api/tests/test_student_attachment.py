...
def test_incomplete_attachments(login, user_student, upload, file_image_jpg, attachments_for_user, logout,
                                user_employee, query_attachments_for_user):
    ...
    data, errors = query_attachments_for_user(user_student, user_student)
    assert errors is None
    assert data is not None
    ...
    data, errors = query_attachments_for_user(user_employee, user_student)
    assert errors is None
    assert data is not None
