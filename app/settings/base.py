"""
Django settings for app challenge.

Generated by 'django-admin startchallenge' using Django 3.1.3.

For more information on this file, see
https://docs.djangochallenge.com/en/3.1/topics/settings/

For the full list of settings and their values, see
https://docs.djangochallenge.com/en/3.1/ref/settings/
"""
...
# See https://docs.djangochallenge.com/en/3.1/howto/deployment/checklist/
...
# Database
# https://docs.djangochallenge.com/en/3.1/ref/settings/#databases
...
# Password validation
# https://docs.djangochallenge.com/en/3.1/ref/settings/#auth-password-validators

AUTH_PASSWORD_VALIDATORS = [{'NAME': 'db.validators.PasswordValidator'}]

# Internationalization
# https://docs.djangochallenge.com/en/3.1/topics/i18n/
...
# https://docs.djangochallenge.com/en/3.1/howto/static-files/
...
# See https://docs.djangochallenge.com/en/3.1/ref/contrib/staticfiles/#manifeststaticfilesstorage
...
MATCHING_VALUE_CHALLENGE_TYPE = 3
...
NUMBER_OF_CHALLENGE_FALLBACK_IMAGES = 5
